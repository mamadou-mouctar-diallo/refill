  ...
  render() {
    ...
    const guestLinks = (
      <div className="navbar-nav">
        <Link
          type="button"
          className="btn btn-outline-success text-dark link-login"
          to="/login"
          title="Log in to be connected"
        >
          <i
        ...
        <Link
          type="button"
          className="btn btn-info text-light link-signup"
          to="/signup"
          title="Sign in to get an acount"
        >
          <i
